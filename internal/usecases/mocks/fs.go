...
import (
	entity "github.com/radiophysiker/link_shortener/internal/entity"
...
// IsFullURLExists provides a mock function with given fields: fullURL
func (_m *URLRepository) IsFullURLExists(fullURL string) bool {
	ret := _m.Called(fullURL)

	if len(ret) == 0 {
		panic("no return value specified for IsFullURLExists")
	}
